...
I will demonstrate that the above argument is sound. Suppose there exists an ordinary agent who knows an infinite number of propositions. This supposes that they have successfully enumerated through an infinite set of propositions and determined credence in every proposition comprising the set. However, it is nigh impossible for an ordinary agent to begin constructing this set, much less to enumerate through it. This contradiction proves \textbf{P1}.
